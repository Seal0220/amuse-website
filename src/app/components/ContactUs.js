      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
          ...
          <form className='space-y-4'>
            ...
            <button
              type='submit'
              className='w-full py-3 select-none rounded-full bg-white text-black font-medium hover:bg-gray-200 transition cursor-pointer'
            >
              {locale.form.submit || 'Send'}
            </button>
          </form>
          ...
          <div className='space-y-4 text-gray-300'>
            <div>
              <p className='font-semibold text-white'>{locale.info.company.name}</p>
              <p className='mt-1'>{locale.info.address.name}</p>
              <p className='mt-1'>{locale.info.phone.name}</p>
              <p className='mt-1'>{locale.info.email.name}</p>
              <p className='mt-1'>{locale.info.hours.name}</p>
            </div>
